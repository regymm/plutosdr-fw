...
adi_ip_create axi_ad9361_s
adi_ip_files axi_ad9361_s [list \
  "$ad_hdl_dir/library/common/ad_rst.v" \
  "$ad_hdl_dir/library/xilinx/common/ad_data_clk.v" \
  "$ad_hdl_dir/library/xilinx/common/ad_data_in.v" \
  "$ad_hdl_dir/library/xilinx/common/ad_data_out_s.v" \
...
adi_ip_properties axi_ad9361_s
adi_ip_ttcl axi_ad9361_s "../common/ad_pps_receiver_constr.ttcl"

adi_init_bd_tcl
adi_ip_bd axi_ad9361_s "bd/bd.tcl"
...
set_property enablement_dependency {spirit:decode(id('MODELPARAM_VALUE.CMOS_OR_LVDS_N')) == 0} \
  ...
  [ipx::get_ports tx_clk_out_s    -of_objects [ipx::current_core]] \
  [ipx::get_ports tx_frame_out_s  -of_objects [ipx::current_core]] \
  [ipx::get_ports tx_data_out_s   -of_objects [ipx::current_core]]
